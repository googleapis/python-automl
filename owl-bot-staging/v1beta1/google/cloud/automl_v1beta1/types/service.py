...
class ListTableSpecsResponse(proto.Message):
    ...
    table_specs = proto.RepeatedField(proto.MESSAGE, number=1,
...
class UpdateTableSpecRequest(proto.Message):
    ...
    table_spec = proto.Field(proto.MESSAGE, number=1,
        message=gca_table_spec.TableSpec,
    )
...
class ListColumnSpecsResponse(proto.Message):
    ...
    column_specs = proto.RepeatedField(proto.MESSAGE, number=1,
...
class UpdateColumnSpecRequest(proto.Message):
    ...
    column_spec = proto.Field(proto.MESSAGE, number=1,
        message=gca_column_spec.ColumnSpec,
    )
...
class ListModelsResponse(proto.Message):
    ...
    model = proto.RepeatedField(proto.MESSAGE, number=1,
        message=gca_model.Model,
    )
...
class DeployModelRequest(proto.Message):
    ...
    image_object_detection_model_deployment_metadata = proto.Field(proto.MESSAGE, number=2, oneof='model_deployment_metadata',
...
class ListModelEvaluationsResponse(proto.Message):
    ...
    model_evaluation = proto.RepeatedField(proto.MESSAGE, number=1,
