...
ModelEvaluation = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      annotation_spec_id:
          ...
          CLASSIFICATION  [prediction\_type-s][google.cloud.automl.v1.Ta
          blesModelMetadata.prediction\_type] the [display\_name][google
          .cloud.automl.v1.ModelEvaluation.display\_name] field is used.
      display_name:
          ...
          CLASSIFICATION  [prediction\_type-s][google.cloud.automl.v1.Ta
          blesModelMetadata.prediction\_type] distinct values of the
