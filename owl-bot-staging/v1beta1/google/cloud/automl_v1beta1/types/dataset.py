...
class Dataset(proto.Message):
    ...
    video_classification_dataset_metadata = proto.Field(proto.MESSAGE, number=31, oneof='dataset_metadata',
        message=video.VideoClassificationDatasetMetadata,
    )

    video_object_tracking_dataset_metadata = proto.Field(proto.MESSAGE, number=29, oneof='dataset_metadata',
    ...
    tables_dataset_metadata = proto.Field(proto.MESSAGE, number=33, oneof='dataset_metadata',
