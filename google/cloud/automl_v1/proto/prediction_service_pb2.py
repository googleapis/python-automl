...
PredictRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      params:
          ...
          ``feature_importance``    (boolean) Whether  [feature_importan
          ce][google.cloud.automl.v1.TablesModelColumnInfo.feature_impor
          tance] is populated in the returned list of
...
BatchPredictRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      params:
          ...
          </h4>  ``score_threshold``    (float) A value from 0.0 to 1.0.
          ...
          Set to true to request segment-level classification. AutoML
          Video Intelligence returns labels and their confidence scores
          for the    entire segment of the video that user specified in
          the request    configuration. The default is true.
          ``shot_classification``    (boolean) Set to true to request
          shot-level classification. AutoML    Video Intelligence
          determines the boundaries for each camera shot in    the
          entire segment of the video that user specified in the request
          ...
          boxes which have at least this confidence score.    Value in 0
          to 1 range, default is 0.5. ``max_bounding_box_count``
