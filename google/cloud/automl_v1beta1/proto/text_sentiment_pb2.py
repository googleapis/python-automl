...
TextSentimentAnnotation = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      sentiment:
          ...
          if train data had only negative sentiment, then sentiment_max,
          would be still negative (although least negative). The
          sentiment shouldn’t be confused with “score” or “magnitude”
