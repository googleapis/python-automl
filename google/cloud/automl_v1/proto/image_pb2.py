...
ImageClassificationModelDeploymentMetadata = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      node_count:
          ...
          gle.cloud.automl.v1.ImageClassificationModelMetadata.node\_qps
...
ImageObjectDetectionModelDeploymentMetadata = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      node_count:
          ...
          ][google.cloud.automl.v1.ImageObjectDetectionModelMetadata.qps
          \_per\_node]. Must be between 1 and 100, inclusive on both
          ends.
  """,
