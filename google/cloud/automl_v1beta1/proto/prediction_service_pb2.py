...
BatchPredictRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      params:
          ...
          -  For Text Classification:  ``score_threshold`` - (float) A
          value from 0.0 to 1.0. When the model makes predictions for a
          text snippet, it will only produce results that have at least
          ...
          from 0.0 to 1.0. When the model makes predictions for a video,
          ...
          AutoML Video Intelligence determines the boundaries for each
          camera shot in the entire segment of the video that user
          specified in the request configuration. AutoML Video
          Intelligence then returns labels and their confidence scores
          for each detected shot, along with the start and end time of
          the shot. WARNING: Model evaluation is not done for this
          ...
          scores for each second of the entire segment of the video that
          user specified in the request configuration. WARNING: Model
          ...
          "false".  -  For Tables:  feature\_importance - (boolean)
          Whether feature importance should be populated in the returned
          ...
          range, default is 0.5. ``max_bounding_box_count`` - (int64) No
          more than this number of bounding boxes will be returned per
          frame. Default is 100, the requested value may be limited by
          server. ``min_bounding_box_size`` - (float) Only bounding
          boxes with shortest edge at least that long as a relative
          value of video frame size will be returned. Value in 0 to 1
          range. Default is 0.
  """,
...
_PREDICTIONSERVICE = _descriptor.ServiceDescriptor(
    ...
    methods=[
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\323\344\223\002<"7/v1beta1/{name=projects/*/locations/*/models/*}:predict:\001*\332A\023name,payload,params'
            ),
        ),
        _descriptor.MethodDescriptor(
            name="BatchPredict",
            ...
            serialized_options=_b(
                "\202\323\344\223\002A\"</v1beta1/{name=projects/*/locations/*/models/*}:batchPredict:\001*\332A&name,input_config,output_config,params\312A'\n\022BatchPredictResult\022\021OperationMetadata"
            ),
        ),
    ],
)
