...
class TablesDatasetMetadata(proto.Message):
    ...
    target_column_correlations = proto.MapField(proto.STRING, proto.MESSAGE, number=6,
        message=data_stats.CorrelationStats,
    )

    stats_update_time = proto.Field(proto.MESSAGE, number=7,
...
class TablesModelMetadata(proto.Message):
    ...
    optimization_objective_recall_value = proto.Field(proto.FLOAT, number=17, oneof='additional_optimization_objective_config')

    optimization_objective_precision_value = proto.Field(proto.FLOAT, number=18, oneof='additional_optimization_objective_config')

    target_column_spec = proto.Field(proto.MESSAGE, number=2,
        message=column_spec.ColumnSpec,
    )

    input_feature_column_specs = proto.RepeatedField(proto.MESSAGE, number=3,
        message=column_spec.ColumnSpec,
    )

    optimization_objective = proto.Field(proto.STRING, number=4)

    tables_model_column_info = proto.RepeatedField(proto.MESSAGE, number=5,
...
class TablesAnnotation(proto.Message):
    ...
    prediction_interval = proto.Field(proto.MESSAGE, number=4,
    ...
    tables_model_column_info = proto.RepeatedField(proto.MESSAGE, number=3,
        message='TablesModelColumnInfo',
    )
