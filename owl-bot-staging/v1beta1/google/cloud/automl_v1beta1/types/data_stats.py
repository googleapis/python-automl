...
class DataStats(proto.Message):
    ...
    float64_stats = proto.Field(proto.MESSAGE, number=3, oneof='stats',
        message='Float64Stats',
    )

    string_stats = proto.Field(proto.MESSAGE, number=4, oneof='stats',
        message='StringStats',
    )

    timestamp_stats = proto.Field(proto.MESSAGE, number=5, oneof='stats',
        message='TimestampStats',
    )

    array_stats = proto.Field(proto.MESSAGE, number=6, oneof='stats',
        message='ArrayStats',
    )

    struct_stats = proto.Field(proto.MESSAGE, number=7, oneof='stats',
        message='StructStats',
    )

    category_stats = proto.Field(proto.MESSAGE, number=8, oneof='stats',
...
class Float64Stats(proto.Message):
    ...
    histogram_buckets = proto.RepeatedField(proto.MESSAGE, number=4,
...
class StringStats(proto.Message):
    ...
    top_unigram_stats = proto.RepeatedField(proto.MESSAGE, number=1,
...
class TimestampStats(proto.Message):
    ...
    granular_stats = proto.MapField(proto.STRING, proto.MESSAGE, number=1,
...
class ArrayStats(proto.Message):
    ...
    member_stats = proto.Field(proto.MESSAGE, number=2,
        message='DataStats',
    )
...
class StructStats(proto.Message):
    ...
    field_stats = proto.MapField(proto.STRING, proto.MESSAGE, number=1,
        message='DataStats',
    )
...
class CategoryStats(proto.Message):
    ...
    top_category_stats = proto.RepeatedField(proto.MESSAGE, number=1,
