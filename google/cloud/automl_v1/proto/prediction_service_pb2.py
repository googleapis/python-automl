...
PredictRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      params:
          ...
          to 25000 characters long.  .. raw:: html     <h4>  AutoML
          Vision Classification  .. raw:: html     </h4>
          ...
          The default is 0.5.  .. raw:: html     <h4>  AutoML Vision
          Object Detection  .. raw:: html     </h4>  ``score_threshold``
          (float) When Model detects objects on the image, it will only
          ...
          .. raw:: html     <h4>  AutoML Tables  .. raw:: html     </h4>
          ``feature_importance``     (boolean) Whether  [feature\_import
          ance][google.cloud.automl.v1.TablesModelColumnInfo.feature\_im
          portance] is populated in the returned list of
...
PredictResponse = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      preprocessed_input:
          ...
          document, the recognized text is returned in the [document\_te
          xt][google.cloud.automl.v1.Document.document\_text] property.
      metadata:
          Additional domain-specific prediction response metadata.  ..
          raw:: html     <h4>  AutoML Vision Object Detection  .. raw::
          html     </h4>  ``max_bounding_box_count``     (int64) The
          maximum number of bounding boxes to return per image.  ..
          raw:: html     <h4>  AutoML Natural Language Sentiment
          Analysis  .. raw:: html     </h4>  ``sentiment_score``
          (float, deprecated) A value between -1 and 1, -1 maps to least
          positive sentiment, while 1 maps to the most positive one and
          the     higher the score, the more positive the sentiment in
          the document     is. Yet these values are relative to the
          training data, so e.g. if     all data was positive then -1 is
          also positive (though the least).     ``sentiment_score`` is
          not the same as "score" and "magnitude" from     Sentiment
          Analysis in the Natural Language API.
  """,
...
BatchPredictRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      params:
          ...
          string must be up to 25000 characters long.  .. raw:: html
          <h4>  AutoML Natural Language Classification  .. raw:: html
          </h4>  ``score_threshold``     (float) A value from 0.0 to
          1.0. When the model makes predictions     for a text snippet,
          it will only produce results that have at least     this
          confidence score. The default is 0.5.  .. raw:: html     <h4>
          AutoML Vision Classification  .. raw:: html     </h4>
          ``score_threshold``     (float) A value from 0.0 to 1.0. When
          the model makes predictions     for an image, it will only
          produce results that have at least this     confidence score.
          The default is 0.5.  .. raw:: html     <h4>  AutoML Vision
          ...
          server.      .. raw:: html         <h4>      AutoML Video
          Intelligence Classification      .. raw:: html         </h4>
          ``score_threshold``     (float) A value from 0.0 to 1.0. When
          ...
          AutoML Video Intelligence returns labels and their confidence
          scores     for the entire segment of the video that user
          specified in the     request configuration. The default is
          true. ``shot_classification``     (boolean) Set to true to
          request shot-level classification. AutoML     Video
          Intelligence determines the boundaries for each camera shot in
          the entire segment of the video that user specified in the
          request     configuration. AutoML Video Intelligence then
          returns labels and     their confidence scores for each
          detected shot, along with the start     and end time of the
          shot. The default is false.  WARNING: Model evaluation is not
          done for this classification type, the quality of it depends
          on training data, but there are no metrics provided to
          describe that quality.  ``1s_interval_classification``
          (boolean) Set to true to request classification for a video at
          one-second intervals. AutoML Video Intelligence returns labels
          and     their confidence scores for each second of the entire
          segment of the     video that user specified in the request
          configuration. The default     is false.  WARNING: Model
          evaluation is not done for this classification type, the
          quality of it depends on training data, but there are no
          metrics provided to describe that quality.  .. raw:: html
          <h4>  AutoML Video Intelligence Object Tracking  .. raw:: html
          </h4>  ``score_threshold``     (float) When Model detects
          objects on video frames, it will only     produce bounding
          boxes which have at least this confidence score.     Value in
          0 to 1 range, default is 0.5. ``max_bounding_box_count``
          (int64) The maximum number of bounding boxes returned per
          image. The     default is 100, the number of bounding boxes
          returned might be     limited by the server.
...
BatchPredictResult = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      metadata:
          ...
          raw:: html     <h4>  AutoML Vision Object Detection  .. raw::
          html     </h4>  ``max_bounding_box_count``     (int64) The
          maximum number of bounding boxes returned per image.  .. raw::
          html     <h4>  AutoML Video Intelligence Object Tracking  ..
          raw:: html     </h4>  ``max_bounding_box_count``     (int64)
          The maximum number of bounding boxes returned per frame.
  """,
...
_PREDICTIONSERVICE = _descriptor.ServiceDescriptor(
    ...
    methods=[
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\323\344\223\0027"2/v1/{name=projects/*/locations/*/models/*}:predict:\001*\332A\023name,payload,params'
            ),
        ),
        _descriptor.MethodDescriptor(
            name="BatchPredict",
            ...
            serialized_options=_b(
                "\202\323\344\223\002<\"7/v1/{name=projects/*/locations/*/models/*}:batchPredict:\001*\332A&name,input_config,output_config,params\312A'\n\022BatchPredictResult\022\021OperationMetadata"
            ),
        ),
    ],
)
